...
describe('Connection', function () {
    ...
    describe('_cors()', function () {

        it('returns CORS headers on single route', function (done) {
        ...
        it('allows CORS headers on multiple routes but not all', function (done) {
        ...
        it('allows same CORS headers on multiple routes with same path', function (done) {
        ...
        it('errors on different CORS headers on multiple routes with same path', function (done) {
        ...
        it('returns CORS headers on single route (overrides defaults)', function (done) {
