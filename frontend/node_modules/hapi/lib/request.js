...
internals.Request.prototype._execute = function () {
    ...
    this._invoke(this.connection._extensions.onRequest, function (err) {

        return self._lifecycle(err);
    });
};
...
internals.Request.prototype._lifecycle = function (err) {
    ...
    var match = this.connection._router.route(this.method, this.path, this.info.hostname);
    ...
    var serverTimeout = this.route.settings.timeout.server;
    if (serverTimeout) {
    ...
    Items.serial(this._route._cycle, function (func, next) {
...
internals.Request.prototype._invoke = function (event, callback) {
    ...
    this._protect.run(callback, function (exit) {
